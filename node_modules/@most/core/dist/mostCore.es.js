...
var runWithLocalTime = function (origin, stream, sink, scheduler) { return stream.run(relativeSink(origin, sink), schedulerRelativeTo(origin, scheduler)); };
...
export { zipArrayValues, withArrayValues, runEffects, loop, scan, startWith, map, constant, tap, ap, chain, join, continueWith, concatMap, mergeConcurrently, mergeMapConcurrently, merge, mergeArray, combine, combineArray, sample, zip, zipArray, filter, skipRepeats, skipRepeatsWith, take, skip, slice, takeWhile, skipWhile, skipAfter, until, since, during, delay, throttle, debounce, recoverWith, throwError, propagateTask, propagateEventTask, propagateErrorTask, propagateEndTask, empty, never, now, at, periodic, newStream, switchLatest, fromPromise, awaitPromises, multicast, MulticastSource };
